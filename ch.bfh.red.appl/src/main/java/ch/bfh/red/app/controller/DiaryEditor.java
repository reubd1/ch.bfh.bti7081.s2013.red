...
public class DiaryEditor extends NavigationView implements ClickListener {
	...
	private Button submit = new Button(null, this);
	...
	public DiaryEditor(Item diaryItem, DiaryAddedCallback diary) {
		...
		this.addListener(new EditorSavedListener() {
			...
			public void editorSaved(EditorSavedEvent event) {
				...
				System.out.println("------------"
						+ newDiaryItem.getBean().getEntry());
				System.out.println("------------"
						+ newDiaryItem.getBean().getFeeling());
